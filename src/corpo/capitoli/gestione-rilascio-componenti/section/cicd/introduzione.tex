...
In particolare \texti{CI} fa riferimento all'integrazione continua. Questo è un processo di automazione
...
Il termine \texti{CD} può assumere un duplice significato: distribuzione continua e/o deployment continuo.

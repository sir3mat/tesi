...
La piattaforma è da considerare come una base su cui costruire e aggiungere futuri componenti in grado di supportare le funzionalità richieste dal cliente per sostenere
...
tutte in un singolo blocco ma vengono puntualmente secondo una cadenza frequente e costante.

In particolare si ha che il processo di sviluppo software nella metodologia agile viene suddiviso in sprint.
Ogni sprint porta allo sviluppo e al rilascio di nuove funzionalità attraverso le seguenti fasi:
\begin{itemize}
    \itemsep0em
    \item Pianificazione: avviene la raccolta dei requisiti connessi a una funzionalità da implementare
    \item Design: vengono progettate le funzionalità
...
Questo porta alla realizzazione di cicli, in cui interagiscono il team di sviluppo e il cliente, che permettono
...
Le pratiche DevOps vengono solitamente applicate nella metodologia agile per poter ottimizzare non solo le fasi di sviluppo del software ma
